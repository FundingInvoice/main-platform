...
//alert(2);
  var myval = $(this).val();
    ...
    $('#payout').html('You could be advanced <span class="cur_amt">&pound' + percent + '</span> upfront');}, 1000);
...
$(window).load(function() {
    ...
    $('#payout').html('You could be advanced <span class="cur_amt">&pound' + percent + '</span> upfront');
    invoicecal_popup($('#edit-duedays-value').val(),$('#edit-invalue-value').val(),$('#edit-turnover').val());
});
function invoicecal_popup(var1,var2,var3)
{
	//alert(var1)	;
	//alert(var2)	;
	//alert(var3)	;
